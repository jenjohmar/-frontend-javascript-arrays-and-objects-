...
const basicInfo = {
  ...
  lastName: "Bakx",
  age: 44,
  birthDate: new Date("August 4, 1977")
}
...
console.log("Hoi! Ik ben " + basicInfo.firstName + ", " + "ik ben " + basicInfo.age + " jaar oud.")
...
const prodDescription = "De " + product.productName + " is gemaakt van " + product.material[0] + " en " + product.material[1];
